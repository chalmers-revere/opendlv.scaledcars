...
# completeBuild.sh - Script to build opendlv.scaledcars.
...
PATH=/opt/od4/bin:$PATH cmake -D OPENDAVINCI_DIR=/opt/od4 -D CMAKE_INSTALL_PREFIX=/opt/opendlv.scaledcars /opt/opendlv.scaledcars.sources
make -j4
EOF
